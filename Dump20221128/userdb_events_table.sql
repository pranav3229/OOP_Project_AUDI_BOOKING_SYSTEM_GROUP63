...
CREATE TABLE `events_table` (
  ...
  `numberofseatsavailable` varchar(45) NOT NULL,
  `eventrevenue` double DEFAULT NULL,
  PRIMARY KEY (`idno`),
  ...
  UNIQUE KEY `numberofseatsavailable_UNIQUE` (`numberofseatsavailable`),
...
INSERT INTO `events_table` VALUES (0000000001,'changed',22,'asdsad','34',NULL),(0000000002,'sndjansd',773,'jsnaflikuahbfiuabueifgbluayFJBfhBKHDslfkhb','4',NULL);
